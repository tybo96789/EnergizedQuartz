package tybo96789.energizedquartz.guis;
...
public class GuiGenerator extends Gui {
	
	private Minecraft mc;

	  public GuiGenerator(Minecraft mc)
	  {
	    super();
	  ...
	  public void onRenderExperienceBar(RenderGameOverlayEvent event)
	  {
	    ...
	    if (!collection.isEmpty())
	    {
	      ...
	      this.mc.renderEngine.bindTexture(new ResourceLocation(EQ_Core.modid,"/gui/generatorInventory.png"));      
